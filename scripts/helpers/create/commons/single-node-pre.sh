...
if ! docker inspect ${WTL_INSTANCE_NAME}-parsoid &> /dev/null ; then
    ...
    wtl-log scripts/helpers/create/commons/single-node-pre.sh 3 NN "[create/single-node] Creating docker ${WTL_INSTANCE_NAME}-parsoid"
fi
...
if ! docker inspect ${WTL_INSTANCE_NAME}-memcached &> /dev/null ; then
    ...
    wtl-log scripts/helpers/create/commons/single-node-pre.sh 3 NN "[create/single-node] Creating docker ${WTL_INSTANCE_NAME}-memcached"
fi
...
if ! docker inspect ${WTL_INSTANCE_NAME}-mysql &> /dev/null ; then
    if [[ -f $WTL_CONFIGS_DIR/mysql-users/root ]] ; then
        ...
        wtl-log scripts/helpers/create/commons/single-node-pre.sh 3 NN "[create/single-node] Using existing mysql root passwd"
    else
        ROOT_PWD=$(echo $RANDOM$RANDOM$(date +%s) | sha256sum | base64 | head -c 32 )
        wtl-log scripts/helpers/create/commons/single-node-pre.sh 3 NN "[create/single-node] Using new mysql root passwd"
    ...
    if [[ -f $WTL_CONFIGS_DIR/mysql-users/wtlmysql ]] ; then
        ...
        wtl-log scripts/helpers/create/commons/single-node-pre.sh 3 NN "[create/single-node] Using existing mysql wtlmysql passwd"
    else
        WTLMYSQL_PWD=$(echo $RANDOM$RANDOM$(date +%s) | sha256sum | base64 | head -c 32 )
        wtl-log scripts/helpers/create/commons/single-node-pre.sh 3 NN "[create/single-node] Using new mysql wtlmysql passwd"
    ...
    wtl-log scripts/helpers/create/commons/single-node-pre.sh 3 NN "[create/single-node] Creating docker ${WTL_INSTANCE_NAME}-mysql"
...
if ! docker inspect ${WTL_INSTANCE_NAME}-restbase &> /dev/null ; then
    ...
    wtl-log scripts/helpers/create/commons/single-node-pre.sh 3 NN "[create/single-node] Creating docker ${WTL_INSTANCE_NAME}-restbase"
fi
